                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('admin.posts.update', [ 'post' => $post->id ]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="col-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="thumb" value="{{ $post->thumb }}" id="file_input" aria-describedby="button-addon2">
                                    </div>
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" class="toggle-input" name="isActive" value="{{ old('isActive') ?? $post->isActive }} id="switch" /><label class="toggle-label" for="switch"></label>
                                    @error('isActive')
