                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('admin.categories.update', [ 'category' => $category->id ]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="checkbox" class="toggle-input" name="isActive" @if ($category->isActive == '1') {{ 'checked' }} @endif id="switch" /><label class="toggle-label" for="switch"></label>
                                    @error('isActive')
