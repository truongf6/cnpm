                ...
                <div class="col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('admin.sliders.update', [ 'slider' => $slider->id ]) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="col-12">
                                    <label class="form-label">Tiêu đề phụ</label>
                                    <input type="text" class="form-control" name="subheading" value="{{ old('subheading') ?? $slider->subheading }}">
                                    @error('subheading')
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="heading" value="{{ old('heading') ?? $slider->heading }}">
                                    @error('heading')
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" name="content" value="{{ old('content') ?? $slider->content }}">
                                    @error('content')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="background" value="{{ $slider->background }}" id="file_input" aria-describedby="button-addon2">
                                    </div>
                                </div>
                                <div class="col-12">
